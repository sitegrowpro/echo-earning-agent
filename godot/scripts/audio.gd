...
func _build_bank() -> void:
	...
	_file_override("tick", "res://audio/clock_tick.wav", false)
	_file_override("tock", "res://audio/clock_tock.wav", false)
	_file_override("creak_open", "res://audio/door_creak_open.wav", false)
	_file_override("creak_close", "res://audio/door_creak_close.wav", false)
	_file_override("step_walk", "res://audio/step_wood.wav", false)
	_file_override("step_run", "res://audio/step_run.wav", false)
	_file_override("step_crouch", "res://audio/step_crouch.wav", false)
	_file_override("step_carpet", "res://audio/step_carpet.wav", false)
	_file_override("step_conc", "res://audio/step_conc.wav", false)
	_file_override("step_grass", "res://audio/step_grass.wav", false)
	_file_override("step_tile", "res://audio/step_tile.wav", false)
	_file_override("crow", "res://audio/crow_caw.wav", false)
	_file_override("knock_soft", "res://audio/knock_soft.wav", false)
	_file_override("knock_heavy", "res://audio/knock_heavy.wav", false)
	_file_override("knock2", "res://audio/knock_double.wav", false)
	_file_override("knock1", "res://audio/knock_single.wav", false)
	_file_override("buzz", "res://audio/phone_buzz.wav", false)
	_file_override("meow", "res://audio/cat_meow.wav", false)
	_file_override("hiss", "res://audio/cat_hiss.wav", false)
	_file_override("purr", "res://audio/cat_purr.wav", false)
	_file_override("tv_loop", "res://audio/tv_murmur.wav", true)
	_file_override("hum_loop", "res://audio/fridge_hum.wav", true)
	_file_override("drone_loop", "res://audio/dark_drone.wav", true)
	_file_override("subbass_loop", "res://audio/sub_rumble.wav", true)
	_file_override("sting", "res://audio/scare_sting.wav", false)
